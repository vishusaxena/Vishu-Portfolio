  ...
  return (
    ...
    <>
      <hr></hr><div className={` text-center h-25   `} style={{backgroundColor:props.mode==="dark" ? 'black':'white' , color:props.mode==="dark" ? 'white':'black' }}>
         <div className='social-icons  '  style={{padding:"2rem 6rem 0rem 6rem",backgroundColor:props.mode==="dark" ? '#00000071':'white' , color:props.mode==="dark" ? 'white':'black' }}>
        <a href="https://in.linkedin.com/in/vishu-saxena-428998234" target="blank"><img className='mx-3'align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/linked-in-alt.svg" alt="vishu saxena" height="30" width="40" /></a>
        <a href="https://instagram.com/ich_vishu" target="blank"><img className='mx-3' align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/instagram.svg" alt="ichvishu" height="30" width="40" /></a>
