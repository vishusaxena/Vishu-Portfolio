  ...
  <div className="col">
    <div className="card  shadow p-3 mb-5 border-primary" style={{backgroundColor:props.mode==="dark" ? 'black':'white' , color:props.mode==="dark" ? 'white':'black' }}>
      <div className="card-body" >
        ...
        <a href="https://github.com/vishusaxena/Newsify.git"  target='_blank'  rel="noreferrer" className="btn btn-primary">Go to Github</a>
...
.</p>
<a href="https://github.com/vishusaxena/TextonTrack.git"  target='_blank'  rel="noreferrer" className="btn btn-primary">Go to Github</a>
  ...
  <div className="col">
    <div className="card shadow p-3 mb-5 border-primary" style={{backgroundColor:props.mode==="dark" ? 'black':'white' , color:props.mode==="dark" ? 'white':'black' }}>
      <div className="card-body">
        ...
        <a href="https://github.com/vishusaxena/TextFIleManager.git"  target='_blank'  rel="noreferrer" className="btn btn-primary">Go to Github</a>
  ...
  <div className="col">
    <div className="card shadow p-3 mb-5 border-primary" style={{backgroundColor:props.mode==="dark" ? 'black':'white' , color:props.mode==="dark" ? 'white':'black' }}>
      <div className="card-body">
        ...
        <a href="https://github.com/vishusaxena/QuizLab.git"  target='_blank'  rel="noreferrer" className="btn btn-primary">Go to Github</a>
